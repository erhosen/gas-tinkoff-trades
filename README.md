...
На этом всё. Теперь при работе с этим документом на всех листах будут доступны новые функции `getPriceByTicker`, `getTrades`, `getMaxBidByTicker` и `getMinAskByTicker`.
